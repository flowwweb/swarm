...
assert.match(app, /role="log" aria-live="polite" aria-relevant="additions"/);
...
const runLogHelpers = vm.runInNewContext(`(() => { const RUN_LOG_CLIENT_LIMIT = 200; ${app.slice(runLogHelperStart, runLogHelperEnd)}; return { runLogBindingKey, runLogItemIdentity, runLogResponseMatches, mergeRunLogItems, runLogNearBottom }; })()`);
