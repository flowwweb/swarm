...
class SwarmSkillStructureTests(unittest.TestCase):
    ...
    def test_ctrl_stream_is_quiet_compact_and_not_templated(self) -> None:
        ...
        self.assertIn("CTRL is also the default review surface", skill)
        self.assertIn("do not send the user hunting through worker tasks or folders", skill)
        self.assertIn("plain caption and its claim limit", skill)
