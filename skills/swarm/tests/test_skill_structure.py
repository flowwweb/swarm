...
class SwarmSkillStructureTests(unittest.TestCase):
    ...
    def test_non_design_review_stops_at_good_enough_without_weakening_design(self) -> None:
        ...
        self.assertIn("In mixed reviews, classify the artifact and each finding", review)
        self.assertIn("[design-guide.md]", skill)
        self.assertIn("Do not spend generation or review cycles on expected ImageGen drift", design)
        self.assertIn("Directional mockup", design)
