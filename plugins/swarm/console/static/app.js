...
const settingGroups = [
  ...
  },
  {
    ...
    experimental: true,
    fields: [
      ["chat_relay.enabled", "Save Codex usage with ChatGPT", "boolean", "Enables eligible ChatGPT routing through a connected bridge."],
      ["chat_relay.routing_mode", "Where to route work", "select", "Auto follows the offload level; Always local keeps work in Codex; Always cloud uses connected ChatGPT actors whenever their tools allow it.", ["auto", "always_local", "always_cloud"], CHAT_RELAY_ENABLED],
      ["chat_relay.offload_level", "How much to offload", "range", "Light is selective; Max uses ChatGPT for every task the connected provider can handle.", "chatRelayLevels", CHAT_RELAY_ENABLED],
      ["chat_relay.default_model", "Routine model", "select", "Model used for routine ChatGPT work.", ["gpt-5.6-luna", "gpt-5.6-sol", "pro"], CHAT_RELAY_ENABLED],
      ["chat_relay.default_effort", "Routine reasoning", "select", "Reasoning level for routine ChatGPT work.", ["minimal", "low", "medium", "high", "xhigh", "pro"], CHAT_RELAY_ENABLED],
      ...
      ["chat_relay.challenging_effort", "Challenging reasoning", "select", "Reasoning level for challenging ChatGPT work.", ["minimal", "low", "medium", "high", "xhigh", "pro"], CHAT_RELAY_ENABLED],
      ["chat_relay.executor_enabled", "Allow ChatGPT to work", "boolean", "Let ChatGPT use approved tools in the connected workspace.", undefined, CHAT_RELAY_ENABLED],
