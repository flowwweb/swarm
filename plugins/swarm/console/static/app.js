...
const settingGroups = [
  ...
  },
  {
    ...
    fields: [
      ...
      ["boost.spark_enabled", "Spark small-work lane", "boolean", "Off by default; shell-only allowlisted work"],
      ["boost.spark_model", "Spark model", "text", "Must declare the simple workload and shell access"],
