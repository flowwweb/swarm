...
SWARM reads local Codex metadata for its console and can write validated settings. Reports involving path handling, loopback isolation, request authorization, configuration writes, Docker mounts, or unintended data exposure are especially useful.
